...
Code.init = function () {
  ...
  function myUpdateFunction(event) {
    ...
    if (event.type != Blockly.Events.BLOCK_CREATE) {
      ...
      Code.latestCode = Blockly.JavaScript.workspaceToCode(Code.workspace);
    }
  }
  ...
  Code.bindClick('runButton', Code.runCode);
...
/**
 * Execute the user's code.
 * Redirect the output to the screen.  Catch infinite loops.
 */
Code.runCode = function () {
  if (!myInterpreter) {
    ...
    setTimeout(function () {
      // Begin execution
      try {
        myInterpreter = new Interpreter(Code.latestCode, initApi);
      } catch (e) {
        alert(e);
      }
      runner = function () {
